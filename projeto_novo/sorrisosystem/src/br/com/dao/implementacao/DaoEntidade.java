...
public class DaoEntidade extends ImplementacaoCrud<Entidade> implements
	...
	public Date getUltimoAcessoEntidadeLogada(String name) {
		...
		SqlRowSet rowSet = super
				.getJdbcTemplate()
				.queryForRowSet(
						"select ent_ultimoacesso from entidade where ent_inativo = 0 and ent_login = ?",
						new Object[] { name });
	...
	public void updateUltimoAcessoUser(String login) {
		String sql = "update entidade set ent_ultimoacesso = current_timestamp where ent_inativo = 0 and ent_login = ? ";
